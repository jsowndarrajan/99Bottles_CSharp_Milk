...
namespace _99Bottles.Tests
{
    public class BottlesTests
    {
        private Bottles _sut;
        ...
        {
            var expected = "99 bottles of milk on the wall, " +
            "99 bottles of milk.\n" +
            "Take one down and pass it around, " +
            "98 bottles of milk on the wall.\n";

            var actual = _sut.Verse(99);
        ...
        {
            var expected = "3 bottles of milk on the wall, " +
            "3 bottles of milk.\n" +
            "Take one down and pass it around, " +
            "2 bottles of milk on the wall.\n";

            var actual = _sut.Verse(3);
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var expected = "2 bottles of milk on the wall, " +
            "2 bottles of milk.\n" +
            "Take one down and pass it around, " +
            "1 bottle of milk on the wall.\n";

            var actual = _sut.Verse(2);
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var expected = "1 bottle of milk on the wall, " +
            "1 bottle of milk.\n" +
            "Take it down and pass it around, " +
            "no more bottles of milk on the wall.\n";

            var actual = _sut.Verse(1);
            Assert.AreEqual(expected, actual);
        }
        ...
        {
            var expected = "No more bottles of milk on the wall, " +
            "no more bottles of milk.\n" +
            "Go to the store and buy some more, " +
            "99 bottles of milk on the wall.\n";

            var actual = _sut.Verse(0);
            Assert.AreEqual(expected, actual);
        }
        ...
        public void TestAFewVerses()
        {
            ...
            var actual = _sut.Verses(2, 0);
            Assert.AreEqual(expected, actual);
        }

        [Test]
        public virtual void TestTheWholeSong()
        {
            var expected = @"99 bottles of milk on the wall, 99 bottles of milk.
